<?php
    /*
    Plugin Name: CTL Arcade - Slot the Fruits
    Plugin URI: http://www.codethislab.com/
    Description: Slot the Fruits for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlotTheFruits{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slot-fruits";
        private $_szPluginName              = "Slot the Fruits";
        private $_szAspectRatio             = "16:7";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "casino, casino game, fruit, gambling, html5 casino, instant win, jackpot, poker, slot, slot machine, videopoker,sweepstakes, lottery, fruit slot, slot fruit";
    ...
    $g_oCTLArcadeSlotTheFruits =  new CTLArcadeSlotTheFruits();
